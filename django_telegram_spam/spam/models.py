...
class User_settings(models.Model):
    ...
    wallet = models.CharField(max_length=256,blank=True)
    hex_address = models.CharField(max_length=256,blank=True)
    private_key = models.CharField(max_length=256,blank=True)
    public_key = models.CharField(max_length=256,blank=True)
...
class Subscriber_WAP(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE,blank=True,null=True)#,default=User)# related_name='user_names'
    days_1 = models.BooleanField()
    days_2 = models.BooleanField()
    days_3 = models.BooleanField()
